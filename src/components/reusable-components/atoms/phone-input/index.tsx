...
export function PhoneInput({
  value: valueProp,
  defaultCountry: defaultCountryProp = 'US',
  className,
  id,
  required = true,
  ...rest
  ...
  const [defaultCountry, setDefaultCountry] =
    React.useState(defaultCountryProp);
  ...
  const handleOnInput = (event: React.FormEvent<HTMLInputElement>) => {
    ...
    let { value: currentValue } = event.currentTarget;
    ...
    const eventTarget = currentEvent.currentTarget;
    if (eventTarget) {
  ...
  const handleOnPaste = (event: React.ClipboardEvent<HTMLInputElement>) => {
    ...
    const { clipboardData } = currentEvent;
